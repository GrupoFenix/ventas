...
class MySQL implements ManejadorBDInterface {
    ...
    private $_clave="";
    private $_base="bookstore";    #Aqui el nombre su "Base de Datos"
    ...
    public function acceso(){
        ...
        $consulta= "SELECT * FROM usuarios WHERE login='$login' AND pasword='$clave'";
        $resultado= mysqli_query($_conexion, $consulta);
